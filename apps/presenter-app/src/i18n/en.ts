...
export const en: Messages = {
  ...
  account: {
    ...
    deleteKeeps: "Purchase records stay with Stripe for accounting and fraud prevention.",
    deleteKeepsAppStore: "Purchase records stay with Apple for accounting and fraud prevention.",
