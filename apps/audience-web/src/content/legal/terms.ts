...
export function termsContent(config: {
  ...
  return {
    ...
    sections: [
      ...
      { id: "moderation", title: "8. モデレーション、通報への対応と主催者の責任", paragraphs: ["LayerTalkは、不適切な投稿や他の利用者への嫌がらせを一切容認しません。観客は、コメントの「通報」ボタンまたはカスタムスタンプの長押しから投稿を通報できます。通報は発表者の画面に直ちに届き、Presenterはその場で投稿の非表示と投稿者のブロックを行えます。", "Presenterは、イベントの性質に応じて承認制、NGワード、投稿停止等を設定し、ルームを適切に運営する責任を負います。これらの機能は不適切な投稿を完全に防止することを保証するものではありません。", `LayerTalkは、サポート窓口（${config.supportEmail}）に寄せられた不適切な投稿の報告を、原則として受領から24時間以内に確認し、本規約に違反する投稿の削除と、投稿者のルームからの締め出しを行います。`] },
      { id: "prohibited", title: "9. 禁止事項", items: ["わいせつ、暴力的、差別的、脅迫的その他他人を著しく不快にさせる内容を投稿する行為（LayerTalkはこれらの投稿を一切容認しません）", "他の利用者への嫌がらせ、つきまとい、なりすまし、またはスパム投稿を行う行為", "法令または公序良俗に反する行為", "第三者の権利、プライバシーまたは名誉を侵害する行為", "サービスの運営を妨害し、過度な負荷を与え、または不正アクセスを試みる行為", "参加コード、認証情報または有料権利を不正に共有・転売する行為", "不正な決済、返金またはチャージバックを試みる行為"] },
