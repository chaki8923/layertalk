...
export const ja = {
  meta: {
    ...
    title: "LayerTalk | スライドに観客のコメント・質問を流すMacのプレゼンツール",
    description: "発表中のスライドに、観客のコメント・質問・スタンプをリアルタイムで流せるMac用アプリ。観客はQRか6文字コードで参加、アプリも登録も不要。PowerPoint・Keynote・Canvaなどそのまま使えます。",
